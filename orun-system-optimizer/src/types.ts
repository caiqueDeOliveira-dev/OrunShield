...
export const JunkCategorySchema = z.enum([
  "temp-file",
  "cache",
  "log-file",
  "old-installer",
...
export const PackageManagerKindSchema = z.enum(["winget", "brew", "apt"]);
export type PackageManagerKind = z.infer<typeof PackageManagerKindSchema>;

export interface OutdatedPackage {
  id: string; // identificador usado pelo package manager (nome do pacote/app)
  displayName: string;
